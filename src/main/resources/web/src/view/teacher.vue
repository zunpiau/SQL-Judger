              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown mr-2">
                  ...
                  <div aria-labelledby="dropdownMenuButton" class="dropdown-menu">
                    ...
                    <div @click="filter.type = type" class="dropdown-item" v-for="type in exerciseTypes">{{ type }}
                    </div>
                  </div>
                </div>
                <button class="btn btn-outline-secondary mr-2" data-target="#importModal" data-toggle="modal">导入题目
                </button>
                <button @click="exercise = emptyExercise" class="btn btn-outline-primary"
                  ...
                  <div class="modal-body">
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label">{{ files.length === 0 ? '请选择 Excel 文件' : files[0].name
                          }}</label>
                      </div>
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <a class=" btn btn-secondary" target="_blank"
                       v-bind:href="'/view/teacher/review.html?id=' + exam.id"
